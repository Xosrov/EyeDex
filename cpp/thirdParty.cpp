...
/////////////////////////////////////////////////////////////////Zlib
std::string zlibencode(const std::string& str, int compressionlevel)
{
...
/** Decompress an STL std::string using zlib and return the original data. */
...
void display_mem_usage()
{
    ...
    std::cout << "Virtual Memory: " << vm_usage << "\nResident set size: " << resident_set << std::endl;
}
